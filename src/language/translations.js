export const translations = {
    AR: {
        ...
        Contact_Section_Lead: "هل أنت مستعد لتحويل عملك؟",
        Contact_Section_Desc: "دعنا نناقش مشروعك ونستكشف كيف يمكننا مساعدتك في تحقيق أهدافك.",
        ...
        Contact_Form_Success: "✅ تم إرسال الرسالة بنجاح! سنعاود الاتصال بك قريبًا.",
        Contact_Form_Error: "❌ فشل في إرسال الرسالة. يرجى المحاولة مرة أخرى أو التواصل معنا مباشرة.",
    ...
    EN: {
        ...
        Contact_Section_Lead: "Ready to transform your business?",
        Contact_Section_Desc: "Let's discuss your project and explore how we can help you achieve your goals.",
        ...
        Contact_Form_Error: "❌ Failed to send message. Please try again or contact us directly.",
    ...
    SE: {
        ...
        Contact_Section_Lead: "Redo att förändra ditt företag?",
        Contact_Section_Desc: "Låt oss diskutera ditt projekt och utforska hur vi kan hjälpa dig att nå dina mål.",
        Contact_Form_Title: "Skicka ett meddelande",
        Contact_Form_Name: "Ditt namn *",
        Contact_Form_Email: "Din e-post *",
        Contact_Form_Phone: "Ditt telefonnummer *",
        Contact_Form_Subject: "Ämne *",
        Contact_Form_Message: "Ditt meddelande *",
        Contact_Form_Send: "Skicka meddelande",
        Contact_Form_Sending: "Skickar...",
        Contact_Form_Success: "✅ Meddelandet skickades! Vi återkommer till dig snart.",
        Contact_Form_Error: "❌ Misslyckades att skicka meddelandet. Försök igen eller kontakta oss direkt.",
        ...
        // Footer
        Ready_Transform: "Redo att förändra ditt företag?",
