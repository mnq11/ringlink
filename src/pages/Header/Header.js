        ...
        <header className={`${styles.header} ${styles.wrapper}`}>
           <div className="wrapper">
                <nav className={styles.navbar}>
                    ...
                    <li><NavLink
                        to="/services"
                        className={location.pathname === '/services' ? `${styles.navLink} ${styles.active}` : styles.navLink}
                    >
                        {t('Services')}
                    </NavLink>
                    </li>
                    ...
                    <li><NavLink
                        to="/contact"
                        className={location.pathname === '/contact' ? `${styles.navLink} ${styles.active}` : styles.navLink}
                    >
                        {t('Contact')}
                    </NavLink></li>
                </nav>
